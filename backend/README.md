...
## Project Structure
    ...
    ├── testapiautoconnect_115256  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_115256`
...
2. Clone this repo and `cd testapiautoconnect_115256`
